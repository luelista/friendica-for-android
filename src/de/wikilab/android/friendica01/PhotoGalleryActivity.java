...
public class PhotoGalleryActivity extends FragmentActivity implements FragmentParentListener {
	TextView header_text;
	PhotoGalleryFragment frag;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		header_text.setText("My Photo Albums");
		
		frag = (PhotoGalleryFragment) getSupportFragmentManager ().findFragmentById(R.id.pl_fragment);
